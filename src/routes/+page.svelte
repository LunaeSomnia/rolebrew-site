<script lang="ts">
    ...
    import ScrollTriggeredDiv from "$lib/components/ScrollTriggeredDiv.svelte";
...
<div class="page-wrapper parallax-base full">
    ...
    <section id="landing-trigger-1" class="features">
        ...
        <div class="max-width-wrapper">
            <ScrollTriggeredDiv
                uniqueId="section-header-1"
                disableOnExit={true}
            >
                <div class="section-header">
                    <Icon icon={IconType.Star} color="var(--primary-color)" />
...
<style lang="scss">
    ...
    .gradient-decoration-fade {
        background: linear-gradient(0deg, #2a2a2e 6.1%, #2a2a2e00 53.05%);
    }
    .gradient-decoration-color {
